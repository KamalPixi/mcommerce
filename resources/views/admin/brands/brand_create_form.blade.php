  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="card card-default">
        <form id="form_category" action="@if(Route::has('brands.store')) {{ route('brands.store') }} @endif" method="POST">
          @CSRF
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                  ...
                  <input value="" type="text" class="form-control" name="brand_name" id="brand_name" placeholder="Enter brand name...">
              </div>
