...
<div class="card">
    ...
    <div class="card-tools">
        <div class="input-group input-group-sm" style="width: 150px; justify-content:right">
            <a href="@if(Route::has('sliders.create')){{ route('sliders.create') }} @endif" class="btn btn-primary btn-sm">Create Slider</a>
        </div>
    </div>
    </div>
    <!-- /.card-header -->
    ...
    <table class="table table-hover text-nowrap">
        ...
        @if(isset($sliders))
            ...
            <tr>
                ...
                <td> <img src="{{ asset('storage/product_images/'.$slider->image) }}" alt="image" style="width:7rem;"> </td>
                ...
                <td style="width:1.5rem;">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <a class="dropdown-item" href="@if( Route::has('sliders.edit') ) {{ route('sliders.edit', $slider->id) }} @endif">Edit</a>

                        <form class="" action="@if( Route::has('sliders.destroy') ) {{ route('sliders.destroy', $slider->id) }} @endif" method="POST">
                          @CSRF
                          @method('DELETE')
